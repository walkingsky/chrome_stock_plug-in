...
function createStockDisplayDOM() {
	...
	else
	{
		...
		for (var i in stockGetInfos) {
			...
			html += "			<div id=\"" + stock.stockCode + "profit\" class=\"turnover\"><br/></div>\r\n";
			html += "			<div id=\"" + stock.stockCode + "kong\" class=\"turnover\"><br/></div>\r\n";
...
function displayPopupStock(stockInfo) {
	try {
		...
		$("#" + stockInfo.stockCode + "profit").html("盈利：" + stockInfo.stockProfit);
